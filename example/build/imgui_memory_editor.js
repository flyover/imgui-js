    ...
    return {
        ...
        execute: function () {
                    ...
                    for (let /*int*/ line_i = clipper.DisplayStart; line_i < clipper.DisplayEnd; line_i++) // display only visible lines
                     {
                        ...
                        for (let /*int*/ n = 0; n < this.Cols && addr < mem_size; n++, addr++) {
                            ...
                            if (this.DataEditingAddr === addr) {
                                ...
                                const flags = ImGui.InputTextFlags.CharsHexadecimal | ImGui.InputTextFlags.EnterReturnsTrue | ImGui.InputTextFlags.AutoSelectAll | ImGui.InputTextFlags.NoHorizontalScroll | ImGui.InputTextFlags.AlwaysOverwrite | ImGui.InputTextFlags.CallbackAlways;
            ...
            (function (MemoryEditor) {
                ...
                })(DataFormat = MemoryEditor.DataFormat || (MemoryEditor.DataFormat = {}));
                class Sizes {
                    constructor() {
